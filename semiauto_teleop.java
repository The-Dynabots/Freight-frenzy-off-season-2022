...
@TeleOp(name = "semiauto_teleop", group = "Linear Opmode")
//@Disabled
public class semiauto_teleop extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        dsfront = hardwareMap.get(DistanceSensor.class,"reach");
        dsright = hardwareMap.get(DistanceSensor.class,"right_ds");
        dsleft = hardwareMap.get(DistanceSensor.class,"left_ds");
        dsback = hardwareMap.get(DistanceSensor.class,"back_ds");
        dsintake = hardwareMap.get(DistanceSensor.class,"intake_ds");
       ...
       // servoTilter = hardwareMap.get(Servo.class, "tilter_servo");
        ...
        Rev2mDistanceSensor sensorTimeOfFlight = (Rev2mDistanceSensor) dsfront;
        ...
        while (opModeIsActive()) {
            ...
            if(gamepad1.a){
                while(dsfront.getDistance(DistanceUnit.INCH)>5) {
                    motorLeftDown.setDirection(DcMotor.Direction.FORWARD);
                    motorRightDown.setDirection(DcMotor.Direction.REVERSE);
                    motorLeftUp.setDirection(DcMotor.Direction.FORWARD);
                    motorRightUp.setDirection(DcMotor.Direction.REVERSE);
